...
| 3 | Database Integration | 1. Open the application and navigate to the registration screen.<br>2. Enter any new username in the "Username" input field.<br>3. Enter a password in the "Password" input field.<br>4. Tap the "Register" button.<br>5. Close the application and open the SQLite database file.<br>6. Run a query to check if the new username exists in the "users" table.<br>7. Verify that the new user’s data is stored in the database. | The new account is successfully stored in the database. |
| 4 | Staff Menu Management | 1. Open the application and log in as a staff member with username: empl and password: pass.<br>2. Navigate to the employee dashboard by tapping "Employee Mode."<br>3. Tap "Manage Menu" to access the menu management screen.<br>4. Select an existing menu item by tapping on it.<br>5. Tap "Edit Stock" and enter a new stock value.<br>6. Tap the "Save Changes" button.<br>7. Return to the menu screen and verify that the stock update is reflected in the system. | The updated stock value is reflected in the system. |
| 5 | Password Security | 1. Open the application and navigate to the registration screen.<br>2. Register a new user by entering any username and password.<br>3. Close the application and open the SQLite database file.<br>4. Run a query to check the stored password in the "users" table.<br>5. Verify that the stored password is hashed and not in plaintext. | Passwords are hashed and not stored in plaintext. |
